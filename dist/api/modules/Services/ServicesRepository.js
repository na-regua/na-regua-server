...
const ServicesSchema_1 = require("./ServicesSchema");
    ...
    index(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const services = yield ServicesSchema_1.ServicesModel.find(filter);
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const newService = yield ServicesSchema_1.ServicesModel.create(body);
                if (!newService) {
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const body = req.body;
                const barber = res.locals.barber;
                const updatedService = yield ServicesSchema_1.ServicesModel.findOneAndUpdate({
                    _id: id,
                    barber: barber._id,
                }, body);
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const barber = res.locals.barber;
                const service = yield ServicesSchema_1.ServicesModel.findByIdAndDelete(id);
                if (!service) {
