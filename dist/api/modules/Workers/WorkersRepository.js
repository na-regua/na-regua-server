...
const WorkersSchema_1 = require("./WorkersSchema");
    ...
    index(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const workers = yield WorkersSchema_1.WorkersModel.find(filters).populate({
                    path: "user",
                    populate: {
                        path: "avatar",
                    },
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const worker = yield WorkersSchema_1.WorkersModel.create({
                    user: workerUser._id,
                    barber: barber._id,
                });
                if (!worker) {
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const worker = yield WorkersSchema_1.WorkersModel.findOne({
                    _id: workerId,
                });
                if (!worker) {
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const deletedWorker = yield WorkersSchema_1.WorkersModel.findByIdAndDelete(workerId);
                if (!deletedWorker) {
                    throw new index_1.HttpException(400, index_1.SYSTEM_ERRORS.WORKER_NOT_FOUND);
                }
